...
<body>
    ...
    <div class="mt-50">
        <div class="container">
            <div class="row">
                <!----- Product Image ----->
                <div class="col-12 col-md-5 box-shadow">
                    <?php echo '<img class="p-auto center" src="data:image/jpeg;base64,'.base64_encode($product_img).'"alt="Product Image '.($product_name).'"class="product"/>'; ?>
                </div>
                <!----- Product Image ----->
